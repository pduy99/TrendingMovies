...
data class MovieDetail(
    ...
    @SerialName("belongs_to_collection") var belongsToCollection: String? = null,
    ...
    @SerialName("production_companies") var productionCompanies: ArrayList<ProductionCompany> = arrayListOf(),
    @SerialName("production_countries") var productionCountries: ArrayList<ProductionCountry> = arrayListOf(),
    ...
    @SerialName("spoken_languages") var spokenLanguages: ArrayList<SpokenLanguage> = arrayListOf(),
